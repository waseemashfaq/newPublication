                                    ...
                                    <form method="post" action="{{route('shop-filter')}}" enctype="multipart/form-data">
                                            ...
                                            <ul class="mt-3">
                                                ...
                                                <li>
                                                    <div class="shop-cb-wrapper radiobtn">
                                                        <input type="radio" id="filterRadio_class{{ $item->ID }}" name="class_id" value="{{ $item->ID }}" class="formRadioInputsBtn">
                                        ...
                                        <div class="single-sidebar-option mt-4">
                                            ...
                                            <ul class="mt-3">
                                                ...
                                                <li>
                                                    <div class="shop-cb-wrapper radiobtn">
                                                        <input type="radio" id="filterRadio{{ $item->ID }}" name="board_id" value="{{ $item->ID }}" class="formRadioInputsBtn">
                        ...
                        <div class="bsb-singleSlide-content-wrapper">
                            <div class="bsb-singleSlide-img position-relative">
                                ...
                                <div class="bestSeller-actionList-wrapper">
                                    <ul>
                                        <li>
                                            <button type="button" onclick="addtocart($item->ID)"><span><i class="fa-solid fa-basket-shopping"></i></span></button>
                                        </li>
                                        <li>

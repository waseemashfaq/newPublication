                                    ...
                                    <form method="post" action="{{route('shop-filter')}}" enctype="multipart/form-data">
                                            ...
                                            <ul class="mt-3">
                                                <li>
                                                    <div class="shop-cb-wrapper">
                                                        <input type="checkbox" id="filterChechbox01" class="formRadioInputsBtn" name="class_id" value="1">
                                                        <label for="filterChechbox01" class="formRadioLabelBtn">
                                                ...
                                                <li>
                                                    <div class="shop-cb-wrapper">
                                                        <input type="checkbox" id="filterChechbox04" class="formRadioInputsBtn">
                                                        <label for="filterChechbox04" class="formRadioLabelBtn">
                                                            <div class="shop-cb-content">
                                                                <div class="shop-cb-check">
                                                                    <span><i class="fa-solid fa-check"></i></span>
                                                                </div>
                                                ...
                                                <li>
                                                    <div class="shop-cb-wrapper">
                                                        <input type="checkbox" id="filterChechbox05" class="formRadioInputsBtn">
                                                        <label for="filterChechbox05" class="formRadioLabelBtn">
                                                            <div class="shop-cb-content">
                                                                <div class="shop-cb-check">
                                                                    <span><i class="fa-solid fa-check"></i></span>
                                                                </div>
                                            ...
                                            <ul class="mt-3">
                                                <li>
                                                    <div class="shop-cb-wrapper radiobtn">
                                                        <input type="radio" id="filterRadio01"  class="formRadioInputsBtn" name="board_id" value="1">
                                                        <label for="filterRadio01" class="formRadioLabelBtn">
                                                            <div class="shop-cb-content">
                                                                <div class="shop-cb-check">
                                                                    <span></span>
                                                                </div>
                                        ...
                                        <div class="single-sidebar-option mt-4">
                                            ...
                                            <ul class="mt-3">
                                                <li>
                                                    <div class="shop-cb-wrapper radiobtn">
                                                        <input type="radio" id="mediumFilterRadio01" name="medium" value="E" class="formRadioInputsBtn" >
                                                ...
                                                <li>
                                                    <div class="shop-cb-wrapper radiobtn">
                                                        <input type="radio" id="mediumFilterRadio02" name="medium" value="U" class="formRadioInputsBtn">
                ...
                <div class="row">
                        ...
                        <div class="single-shopCard-wrapper">
                            <div class="bsb-singleSlide-content-wrapper">
                                <div class="bsb-singleSlide-img position-relative">
                                    <img src="{{ asset('assets/imges/shop/shop-2.png')}}" class="img-fluid">
                                    <div class="bestSeller-actionList-wrapper">
                                        <ul>
                                            <li>
                                                <button type="button"  onclick="addtocart(1)"><span><i class="fa-solid fa-basket-shopping"></i></span></button>
                                            </li>
                                            <li>
                                ...
                                <div class="bsb-singleSlide-desc text-center mt-4">
                                    <h3>Tarjuma-Tul-Quran 11th</h3>
                                    <label class="d-block">Unique Notes</label>
                                    <p class="shop-price mb-0">300 PKR</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 mb-4">
                        <div class="single-shopCard-wrapper">
                            <div class="bsb-singleSlide-content-wrapper">
                                <div class="bsb-singleSlide-img position-relative">
                                    <img src="{{ asset('assets/imges/shop/shop-1.png')}}" class="img-fluid">
                                    <div class="bestSeller-actionList-wrapper">
                                        <ul>
                                            <li>
                                                <button type="button" onclick="addtocart(2)"><span><i class="fa-solid fa-basket-shopping"></i></span></button>
                                            </li>
                                            <li>
                                                <button type="button"><span><i class="fa-regular fa-heart"></i></span></button>
                                            </li>
                                ...
                                <div class="single-cart-item-desc ps-2">
                                    ...
                                    <div class="single-cart-price">
                                        <p ><span class="cart_singleItemtotal{{$subject->id}}">{{$subject->quantity*$subject->price??''}} </span> <sup>PKR</sup>
                                             {{-- <span class="item-cut-price">1600 pkr</span> --}}
                                        </p>
                                    </div>
                ...
                <div class="row gx-0">
                    ...
                    <div class="col-lg-8">
                        <div class="sub-total text-end pt-2">
                            <label class="price cart_subtotalID">{{subTotal()}} <small>PKR</small></label>
                        </div>
                    </div>
                </div>
                <div class="row mt-2">
